...
class Microscope:
    ...
    def auto(self):
        ...
        for i in range(41):
            ...
            current_variance = self.variance(preprocessed_image) #removing noise
        ...
        base_dir = "/media/pi/3332-3561/autoscan"
    ...
    def scan(self):
        ...
        dir_path = "/media/pi/3332-3561/scan_{}/".format(cur_time.strftime("%Y%m%d_%H%M"))
